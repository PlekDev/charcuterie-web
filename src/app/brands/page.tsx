      ...
      <main className="flex-1 pt-32 pb-24 px-6 max-w-7xl mx-auto w-full">
        <div className="flex flex-col items-center text-center gap-6 mb-20">
           <div className="flex items-center gap-2">
              <span className="text-[10px] font-bold uppercase tracking-[0.3em] text-casita-terracotta">Nuestros Provedores</span>
           </div>
           <h1 className="text-5xl md:text-7xl font-serif font-bold text-casita-charcoal">Provedores Seleccionados</h1>
